...
void pd_dpm_snk_evaluate_caps(struct pd_port *pd_port)
{
	...
	DPM_INFO("lsw SrcCap snk_cap nr:%d pdos: 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x 0x%x\n", snk_cap->nr, snk_cap->pdos[0], snk_cap->pdos[1], snk_cap->pdos[2], snk_cap->pdos[3], snk_cap->pdos[4], snk_cap->pdos[5], snk_cap->pdos[6]);
